...
public class TestController {
    ...
    public String chakan(Integer id){
        System.out.println("id="+id);
        return "index";
    }

    @RequestMapping("/getHeader")
    public String getHeader(HttpServletRequest request, HttpSession session) {
        //获取客户端向服务器端传送数据的协议名称
        ...
        //获取ajax地址
        System.out.println("ajax : " + request.getHeader("x-requested-with"));
        //获取请求方语言
